...
const testimonials = [
  {
    ...
    content: 'Tirth Travels made planning my adventure trip so easy. Their attention to detail and personalized service was outstanding! Every moment was perfectly planned.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'As a frequent business traveler, I appreciate their efficient service and reliable support. They always go above and beyond to ensure my trips are smooth.',
    rating: 5,
    location: 'Singapore'
  },
  {
    ...
    content: 'Our family vacation was perfect thanks to Tirth Travels. They thought of everything, making it stress-free for us. The kids had an amazing time!',
    rating: 5,
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Don't just take our word for it - hear from our satisfied travelers about their experiences with Tirth Travels.
          </p>
        </motion.div>
